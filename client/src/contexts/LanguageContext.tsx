...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "booking.whatHappensNext": "ماذا يحدث بعد ذلك؟",
    "booking.whatHappensNextDescription": "سيتم مراجعة حجزك من قبل المكتب. ستحصل على بريد إلكتروني للتأكيد بمجرد الموافقة، عادة خلال 24 ساعة.",
