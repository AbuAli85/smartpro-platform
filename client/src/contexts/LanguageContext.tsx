...
export const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "booking.currentSchedule": "الموعد الحالي",
    ...
    "booking.reasonPlaceholder": "يرجى شرح سبب حاجتك لإعادة الجدولة...",
    ...
    "booking.rescheduleError": "فشل في إعادة جدولة الحجز",
    "booking.selectDateTime": "يرجى اختيار التاريخ والوقت",
    "booking.reasonRequired": "يرجى تقديم سبب لإعادة الجدولة",
    "booking.noSlotsAvailable": "لا توجد أوقات متاحة لهذا التاريخ",
    "booking.sameDateTimeWarning": "لقد اخترت نفس التاريخ والوقت. يرجى اختيار موعد مختلف.",
    ...
    "booking.timeline.appointmentScheduled": "تم جدولة الموعد في",
    "booking.timeline.serviceCompleted": "تمت الخدمة بنجاح",
    ...
    "booking.timeline.nextSteps.pending": "في انتظار تأكيد المكتب. سيتم إعلامك بمجرد التأكيد.",
    ...
    "chat.hint": "يتم الرد على الرسائل عادة خلال بضع ساعات في أوقات العمل",
    "chat.sendError": "فشل في إرسال الرسالة",
    "chat.emptyMessage": "يرجى كتابة رسالة قبل الإرسال",
    "documents.title": "المستندات والتسليمات",
    "documents.description": "عرض وتنزيل المستندات المكتملة من خدمتك",
    ...
    "documents.downloadStarted": "بدأ التنزيل",
    "documents.processing": "جاري المعالجة",
    "documents.infoTitle": "معلومات مهمة",
    "documents.infoMessage": "جميع المستندات مخزنة بشكل آمن ويمكن تنزيلها في أي وقت. احتفظ بهذه المستندات في مكان آمن لسجلاتك.",
    "payment.title": "معلومات الدفع",
    "payment.description": "عرض تفاصيل الدفع وتنزيل الفواتير",
    ...
    "payment.downloadInvoice": "تنزيل الفاتورة",
    "payment.downloadReceipt": "تنزيل الإيصال",
    "payment.invoiceDownloadStarted": "بدأ تنزيل الفاتورة",
    "payment.receiptDownloadStarted": "بدأ تنزيل الإيصال",
    ...
    "reminders.scheduledFor": "موعد محدد",
    ...
    "reminders.emailDesc": "استلم التذكيرات عبر البريد الإلكتروني",
    "reminders.smsReminder": "إشعارات SMS",
    "reminders.smsDesc": "استلم التذكيرات عبر رسائل SMS",
    "reminders.active": "نشط",
    "reminders.willBeSentAt": "سيتم الإرسال في",
    "reminders.settingsUpdated": "تم تحديث إعدادات التذكير",
    "reminders.updateError": "فشل في تحديث إعدادات التذكير",
