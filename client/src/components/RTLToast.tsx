...
/**
 * RTL-Aware Toast Notification System
 * 
 * Toast notifications that slide from the appropriate side based on language direction.
 * In RTL mode, toasts slide from the right; in LTR mode, from the left (or right based on position).
 * 
 * @example
...
>(({ className, variant, ...props }, ref) => {
  const toastAnimation = useRTLAnimation('toast');
